...
public class ListGame {
    ...
    public ListGame() {
        ...
        gameList[4] = new GameObject(13, 13,
        ...
        gameList[8] = new GameObject(9, 10,
        ...
        gameList[9] = new GameObject(11, 12,
        ...
        gameList[12] = new GameObject(4, 1,
    ...
    public static void game(GameObject object) {
        ...
        if (object.getNodeOne() == object.getNodeTwo()) {
            System.out.println(ListGame.gameList[object.getNodeOne()].getText());
            return;
        }
        System.out.println("Введите 1, 2 или 3");
        Scanner scanner = new Scanner(System.in);
        int choose = scanner.nextInt();
        if (choose == 1) ListGame.game(ListGame.gameList[object.getNodeOne()]);
        else if (choose == 2) ListGame.game(ListGame.gameList[object.getNodeTwo()]);
        else if (choose==3) Menu.getSecondCommand(object).execute();
        else {
            System.out.println("Введите 1, 2 или 3");
            ListGame.game(object);
        }
    }
